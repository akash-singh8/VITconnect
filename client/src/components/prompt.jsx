        ...
        <div className="box">
          ...
          <div className="heading">
            <h1 className="life_coaching">
              Your personal chatbot companion for VIT Bhopal Clubs realated
              conversations.
            </h1>
          </div>
          <hr className="line" />
          ...
          <div className="input_prompt">
            ...
            <form onSubmit={handleSubmit} className="jaehj">
              <input
                type="text"
                className="prompt"
              ...
              />
              <button type="submit" className="send1" disabled={loading}>
